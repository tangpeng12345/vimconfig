...
hi DiffText guifg=NONE guibg=#0909b5 guisp=#0909b5 gui=NONE ctermfg=NONE ctermbg=19 cterm=NONE
...
hi DiffDelete guifg=#6b4949 guibg=#220000 guisp=#220000 gui=NONE ctermfg=95 ctermbg=52 cterm=NONE
...
hi DiffAdd guifg=#cad5db guibg=#0000e6 guisp=#0000e6 gui=NONE ctermfg=152 ctermbg=20 cterm=NONE
...
syn match cFunctions "<[a-zA-Z_][a-zA-Z_0-9]*>[^()]*)("me=e-2 contains=cFunctions
syn match cFunctions "<[a-zA-Z_][a-zA-Z_0-9]*>s*("me=e-1 contains=cFunctions
